    ...
    <section className="py-24 bg-gray-50" ref={ref}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <Link
            href="/properties"
            className="inline-flex items-center gap-2 text-sogif-cyan hover:text-sogif-navy font-semibold transition-colors shrink-0"
          >
            View All Properties
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {properties.map((property, index) => (
            ...
            >
              ...
              {/* Content */}
              <div className="p-6">
                <h3 className="text-xl font-bold text-sogif-navy mb-2 group-hover:text-sogif-cyan transition-colors">
                  {property.title}
                </h3>
        ...
        >
          <div className="inline-flex items-center gap-3 bg-sogif-navy/5 rounded-full px-6 py-3">
            <svg className="w-5 h-5 text-sogif-navy" fill="none" stroke="currentColor" viewBox="0 0 24 24">
